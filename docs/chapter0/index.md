...
<div class="section">
        ...
        <div class="explanation">
            <strong>この章のまとめ：</strong>
            <ul>
                <li>CPU・メモリ・ストレージなどの役割を、図と比喩を通じてイメージできる</li>
                <li>OSはアプリケーションとハードウェアのあいだで「通訳」のような役割を果たしている</li>
                <li>サーバーは特別な機械ではなく、「サービスを提供する役割」を持ったコンピュータである</li>
            </ul>
        </div>
</div>
